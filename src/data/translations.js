export const translations = {
  en: {
    ...
    chatVoiceSecureContext: "Voice input requires HTTPS or localhost. Open the app in a secure context.",
    chatVoicePermissionDenied: "Microphone permission is blocked. Allow mic access in browser settings and try again.",
    chatVoiceNoSpeech: "No speech detected. Try speaking clearly and closer to the microphone.",
    chatVoiceNetworkError: "Voice recognition failed due to a network issue. Check your internet and retry.",
    chatVoiceGenericError: "Could not start voice input. Please retry.",
  ...
  hi: {
    ...
    catWomenChildWelfare: "महिला एवं बाल कल्याण",
    catInsurance: "बीमा",
    catSocialSecurity: "सामाजिक सुरक्षा",
    catEmploymentBusiness: "रोजगार / व्यापार",
    catTribalWelfare: "आदिवासी कल्याण",
    catEmploymentLivelihood: "रोजगार / आजीविका",
    catSocialWelfare: "समाज कल्याण",
    catFoodSecurity: "खाद्य सुरक्षा",
    catNutrition: "पोषण",
    ...
    chatVoiceSecureContext: "वॉइस इनपुट के लिए HTTPS या localhost आवश्यक है। ऐप को सुरक्षित संदर्भ में खोलें।",
    chatVoicePermissionDenied: "माइक्रोफ़ोन अनुमति अवरुद्ध है। ब्राउज़र सेटिंग्स में अनुमति दें और फिर प्रयास करें।",
    chatVoiceNoSpeech: "कोई आवाज़ दर्ज नहीं हुई। कृपया माइक्रोफ़ोन के पास स्पष्ट बोलें और फिर प्रयास करें।",
    chatVoiceNetworkError: "नेटवर्क समस्या के कारण वॉइस पहचान विफल हुई। इंटरनेट जांचकर पुनः प्रयास करें।",
    chatVoiceGenericError: "वॉइस इनपुट शुरू नहीं हो सका। कृपया पुनः प्रयास करें।",
